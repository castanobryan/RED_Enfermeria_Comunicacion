...
public class CheckManager2 : MonoBehaviour {
	...
	public void CheckCross2()
	{
		...
		str1 = Input1.text + Input2.text + Input3.text + Input4.text + Input5.text + Input6.text + Input7.text;
		str2 = Input30.text + Input31.text + Input32.text + Input33.text + Input34.text + Input35.text + Input24.text + Input36.text + Input37.text;
		str3 = Input13.text + Input14.text + Input15.text + Input9.text + Input16.text + Input17.text;
		str4 = Input18.text + Input19.text + Input20.text + Input21.text + Input14.text + Input22.text;
		str5 = Input8.text + Input9.text + Input10.text + Input11.text + Input7.text + Input12.text;
		str6 = Input23.text + Input24.text + Input25.text + Input26.text + Input27.text + Input28.text + Input29.text + Input17.text;
		str7 = Input38.text + Input37.text + Input39.text + Input40.text + Input41.text + Input42.text;
